...
import { overrideDefaultIntegrations } from './utils';
import * as Native_1 from '@sentry/react-native';
export { Native_1 as Native };
const isBareWorkflow = Constants.executionEnvironment === ExecutionEnvironment.Bare;
export const init = (options = {}) => {
    let manifest = Updates.manifest;
    ...
    if (Array.isArray(nativeOptions.integrations)) {
        ...
        nativeOptions.integrations = overrideDefaultIntegrations(defaultExpoIntegrations, nativeOptions.integrations);
    }
        ...
        const functionWithExpoIntegrations = (integrations) => {
            return functionWithoutExpoIntegrations(overrideDefaultIntegrations(integrations, defaultExpoIntegrations));
        };
